...
export function FireDoorsOverview() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <p className="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
            Our fire resistant doors division manufactures certified fire-rated doors in various
            sizes and configurations. We also supply isolation materials, lock-frame assemblies,
            and wood-laminated finishes to meet diverse commercial safety requirements.
          </p>
        </motion.div>
      </Container>
    </section>
