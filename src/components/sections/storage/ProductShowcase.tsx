  ...
  return (
    <section id="product" className="py-24 md:py-32 bg-gray-50">
      <Container>
        ...
        >
          <div className="aspect-[4/3] bg-gradient-to-br from-gray-200 to-gray-100 rounded-2xl flex items-center justify-center">
          ...
          <div>
            ...
            <h2 className="mt-2 text-3xl md:text-4xl font-heading font-bold text-navy-900 leading-tight">
