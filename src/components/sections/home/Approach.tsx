...
export function Approach() {
  return (
    <section className="py-16 md:py-20 lg:py-28 bg-white dark:bg-navy-900 border-b border-gray-100 dark:border-navy-800">
      <Container>
        <SectionHeading
          title="Our Approach"
            ...
            return (
              ...
              >
                <div className="w-14 h-14 mx-auto rounded-2xl bg-navy-50 dark:bg-navy-800/50 flex items-center justify-center mb-5">
                  <Icon className="w-7 h-7 text-navy-500 dark:text-navy-200" />
                </div>
