...
export const medicalProducts = [
  ...
  },
  {
    ...
    specs: [
      "**Tabletop Dimensions:** 60 × 40 cm",
      "**Height Adjustment Range:** 65–90 cm",
      "**Maximum Lifting Load:** 60 kg",
      "**Lifting Column Duty Cycle:** 100% continuous duty",
      "**Motion Control:** MCU-based electronic speed control",
      "**Movement Profile:** Soft start and soft stop",
      "**Operating Voltage:** 100–240 V AC",
      "**Input Frequency:** 50/60 Hz",
      "**Maximum Current:** 1 A",
      "**Electrical Protection:** Class II",
      "**Tabletop Finish:** Scratch-resistant laminated surface",
      "**Main Construction:** Rigid powder-coated steel",
      "**Base:** Four lockable caster wheels",
      "**Table Weight:** Approximately 26 kg",
      "**Safety Standard:** Designed with reference to IEC 60601-1",
    ],
    benefits: [
      "**Precise Positioning:** MCU-based speed control provides accurate height adjustment with smooth, stable movement.",
      "**Soft Start & Soft Stop:** Smooth acceleration and deceleration protect instruments and improve patient comfort.",
      "**100% Duty-Cycle Lifting Column:** Continuous-duty lifting column designed and manufactured by Medimarks Technologies for reliable, long-lasting operation.",
      "**60 kg Lifting Capacity:** Supports up to 60 kg of medical, diagnostic and examination equipment.",
      "**Low-Noise Operation:** Quiet motorized movement suitable for hospitals, clinics and examination rooms.",
      "**One-Touch Power Shutdown:** Quick power shutdown saves energy and helps extend the life of the control electronics.",
      "**Rigid and Durable Construction:** Powder-coated steel structure with a scratch-resistant laminated tabletop.",
      "**Mobile and Stable:** Four smooth-rolling caster wheels with locking brakes provide easy movement and secure positioning.",
    ],
  ...
  },
  {
    ...
    specs: [
      "**Models:** TA-70S / TA-70C",
      "**Tabletop Options:** TA-70S: straight-edged rectangular tabletop; TA-70C: curved tabletop",
      "**Tabletop Dimensions:** 90 × 50 cm (35.4 × 19.7 in)",
      "**Height Adjustment Range:** 65–90 cm (25.6–35.4 in)",
      "**Maximum Lifting Load:** 110 kg (243 lb)",
      "**Under-Table Shelf:** 30 × 20 × 7 cm (11.8 × 7.9 × 2.8 in)",
      "**Base Footprint:** Approx. 70 × 40 cm (27.6 × 15.7 in)",
      "**Operating Voltage:** Automatic 100–240 V AC",
      "**Input Frequency:** 50/60 Hz",
      "**Maximum Current:** 1 A",
      "**Electrical Protection:** Class I",
      "**Table Weight:** Approx. 28 kg",
      "**Tabletop Finish:** Scratch-resistant laminated surface",
      "**Base Options:** Four lockable caster wheels or fixed base",
      "**Safety Standard:** Designed with reference to IEC 60601-1",
      "**Historical Note:** First-generation electrical instrument table designed and manufactured by MEDIMARKS Technologies.",
    ],
    benefits: [
      "**Heavy-Duty 110 kg Lifting Capacity:** Supports up to 110 kg of medical, diagnostic and examination equipment.",
      "**Large Instrument Tabletop:** The 90 × 50 cm tabletop provides generous space for medical instruments and accessories.",
      "**Two Tabletop Configurations:** Available in two model options: TA-70S with a straight-edged rectangular tabletop. TA-70C with a curved tabletop for improved practitioner access.",
      "**Electric Height Adjustment:** Provides smooth height adjustment from 65 to 90 cm for accurate equipment positioning.",
      "**Quiet Operation:** Designed for low-noise use in clinics, hospitals and examination rooms.",
      "**Integrated Under-Table Shelf:** Provides convenient storage for accessories, control units and small equipment.",
      "**Mobile or Fixed Installation:** Available with four lockable caster wheels or a fixed-base configuration.",
      "**Scratch-Resistant Surface:** Durable laminated tabletop suitable for regular clinical use.",
      "**Strong and Stable Construction:** Heavy-duty structure designed to support high equipment loads safely.",
    ],
