    ...
    <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-10 lg:px-16 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white">Need Fire Resistant Doors?</h2>
          <p className="mt-4 text-gray-300 max-w-xl mx-auto">Contact us for fire-rated doors, isolation materials, or custom door solutions.</p>
          <div className="mt-8">
