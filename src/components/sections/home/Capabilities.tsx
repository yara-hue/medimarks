        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {divisions.map((division, index) => {
            ...
            return (
              ...
              >
                <div className="group relative bg-white rounded-xl border border-gray-200/60 p-8 h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-gray-200/50">
                  <div className="w-12 h-12 rounded-lg bg-navy-50 flex items-center justify-center mb-5 group-hover:bg-navy-100 transition-colors">
                    <Icon className="w-6 h-6 text-navy-500" />
                  </div>
