      ...
      <Container>
        ...
        >
          ...
          <p className="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
            Our automation division delivers CNC machining services, custom linear actuation systems,
            and precision-engineered components for industrial applications. From 4-axis CNC routing
            to custom automation assemblies, we provide end-to-end manufacturing solutions.
          </p>
        </motion.div>
      </Container>
    </section>
