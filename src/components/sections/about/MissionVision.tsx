      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          <motion.div
            ...
            className="bg-white rounded-2xl p-10 md:p-12 border border-gray-200/60"
          >
            ...
            <blockquote className="mt-4 font-heading text-2xl md:text-3xl font-bold text-navy-900 leading-tight">
