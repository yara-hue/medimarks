      ...
      <Container>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {capabilities.map((item, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-navy-50 dark:bg-navy-700 flex items-center justify-center text-xl mb-5">
                {item.icon}
              </div>
        ...
        >
          <div className="aspect-[3/1] max-w-2xl mx-auto flex items-center justify-center">
            <span className="text-gray-600 dark:text-gray-300 text-sm tracking-widest uppercase">Manufacturing Facility — Image Placeholder</span>
          </div>
        </motion.div>
      </Container>
    </section>
